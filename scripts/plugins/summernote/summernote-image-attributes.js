            ...
            this.initialize=function(){
                ...
                if(options.imageDialogLayout=='horizontal'){
                    ...
                    var body='<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.title+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.src+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group note-group-select-from-files">'+
                                '<label class="note-image-attributes"></label>'+
                            ...
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.alt+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.class+'</label>'+
								'<input type="text" class="note-image-attributes form-control">'+
								'<div class="input-group-btn">'+
									'<select class="note-image-attributes btn btn-default">'+
									'<option value="">'+lang.imageAttributes.classSelect+'</option>'+
										$shapesOptions+
									'</select>'+
								'</div>'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.style+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.role+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<h4>'+lang.imageAttributes.pluginLinkTitle+'</h4>'+
                            '<hr>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.href+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.target+'</label>'+
								'<select id="note-image-attributes-link-target" class="note-image-attributes form-control">'+
									'<option value="_self">Self</option>'+
									'<option value="_blank">Blank</option>'+
									'<option value="_top">Top</option>'+
									'<option value="_parent">Parent</option>'+
                            ...
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.linkClass+'</label>'+
                                '<input type="text" class="note-image-attributes form-control">'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.rel+'</label>'+
								'<select id="note-image-attributes-link-rel" class="note-image-attributes form-control">'+
									'<option value="">'+lang.imageAttributes.relBlank+'</option>'+
									'<option value="alternate">'+lang.imageAttributes.relAlternate+'</option>'+
									'<option value="author">'+lang.imageAttributes.relAuthor+'</option>'+
									'<option value="bookmark">'+lang.imageAttributes.relBookmark+'</option>'+
                            ...
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="note-image-attributes">'+lang.imageAttributes.linkRole+'</label>'+
                                '<input type="text" id="note-image-attributes-link-role" class="note-image-attributes form-control">'+
                            '</div>';
                        }
