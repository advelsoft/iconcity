		...
		<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<h4 class="page-top"><a href="<?php echo base_url()."index.php/Common/Promotion/BitDefender";?>"><b>Continue Shopping</b></a></h4>
					...
					<?php if ($cart = $this->cart->contents()): ?>
						...
						<?php
							...
							echo form_open("index.php/Common/BitDefender/OrderUpdate", $attributes);
							$grand_total = 0;
						...
						<tbody>
							<tr>
								...
								<td style="text-decoration: underline;"><?php echo anchor('index.php/Common/BitDefender/OrderRemove/'.$item['rowid'],'Delete'); ?></td>
								<?php endforeach; ?>
							</tr>
						</tbody>
						<tfoot>
...
function clear_cart() {
	...
	if(result) {
		window.location = "<?php echo base_url(); ?>index.php/Common/BitDefender/OrderRemove/All";
	}else{
...
function place_order(){
	window.location = "<?php echo base_url(); ?>index.php/Common/BitDefender/CheckOut";
}
</script>