	...
	<div class="row row-header">
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				<?php $attributes = array("id" => "statementform", "name" => "statementform");
				echo form_open("index.php/Common/Outstanding/Statement", $attributes);?>
					...
					<div class="form-horizontal">
						<div class="form-group">
                            ...
                            <div class="col-md-9">
								...
								<input id="hdnUserId" name="hdnUserId" type="hidden" value="<?php echo $statement['UserID']; ?>" />
								<input id="hdnPassword" name="hdnPassword" type="hidden" value="<?php echo $statement['Password']; ?>" />
								<input id="PropertyNo" name="PropertyNo" type="hidden" value="<?php echo $statement['PropertyNo']; ?>" />
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-9">
								...
								<input id="hdnStatement" name="hdnStatement" type="hidden" value="<?php echo $statement['StatementPage']; ?>" />
								<input id="CondoSeqNo" name="CondoSeqNo" type="hidden" value="<?php echo $statement['CondoSeq']; ?>" />
								<input id="LoginId" name="LoginId" type="hidden" value="<?php echo $_SESSION['username']; ?>" />
                            </div>
                        </div>
					</div>
				</div>
				<div class="panel-footer">
					<div id="btns" style='margin: 0 auto;text-align:center'>
						<button id="generate" class="btn btn-sm btn-grey" style="color: white; text-transform: uppercase;" onclick="return generateStatement();">Generate Statement</button>
					</div>
				</div>
				<?php echo form_close(); ?>
			</div>
...
<script>
	...
	function generateStatement(){
		try{
			//alert(document.ctl00.UsershdnStatement.value);
			//if (checkform()){
			...
			//alert(document.ctl00.SPhdnStatement.value);
			//} else { return false; }
		}catch(e){alert(e)}
	}
