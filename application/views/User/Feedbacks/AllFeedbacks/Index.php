		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div><a href="<?php echo base_url()."index.php/Common/AllFeedbacks/Create";?>">New Feedbacks/Requests</a></div></br>
							...
							<tbody>
								<?php if (count($feedbacksList) > 0): ?>
									...
									<tr>
										...
										<td>   
											<a href="<?php echo base_url()."index.php/Common/AllFeedbacks/Detail/".$item['feedbackID']; ?>" style="text-align:center">
