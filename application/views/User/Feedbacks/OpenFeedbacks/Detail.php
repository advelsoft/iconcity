					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<?php foreach($replyFeedbacks as $item) { ?>
								...
								<?php { echo '<br><br><div class="ticket-message message-right first clearfix">'; } ?>
								<?php else: ?>
								<?php { echo '<br><br><div class="ticket-message message-left first clearfix">'; } ?>
								<?php endif;?>
									...
									<div class="text">
										...
										<?php else: ?>
											<div class="message"> 
												...
												<?php if (isset($item['attach1'])): ?>
													<div class="files-holder clearfix">
														<a href="<?php echo trim($item['attach1']); ?>" class="file clearfix" target="_blank">
