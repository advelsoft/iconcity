		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>In Progress Feedbacks/Requests</h4>
				</div>
									...
									<tr>
										...
										<td>
											<div class="btn btn-sm btn-grey" style="text-align:center">    
											  <a href="<?php echo base_url()."index.php/Common/InProgressFeedbacks/Detail/".$item['feedbackID']; ?>" style="text-align:center">View</a>
											</div>
										</td>	
									</tr>
									<?php } ?>
