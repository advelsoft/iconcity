	...
	<div class="row row-header">
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				echo form_open_multipart("index.php/Common/Forms/Create/".$condoSeq, $attributes);?>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-3">
                                Admin&nbsp;&nbsp;
								<input id="Admin" name="Admin" type="checkbox" value="1" <?php echo set_checkbox('Admin','1'); ?> />&nbsp;
