	...
	<div class="row row-header">
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				echo form_open_multipart("index.php/Common/Eset/Create", $attributes);?>
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							<label for="ProductName" class="create-label col-md-2">Product Name</label>
                            <div class="col-md-5">
                                <input id="ProductName" name="ProductName" placeholder="Product Name" type="text" class="form-control" value="" />
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control" id="ProductImage" name="ProductImage" rows="4"></textarea>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="NormalPrice" name="NormalPrice" placeholder="Normal Price" type="text" class="form-control" value="" />
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
								<input id="PromoDate" name="PromoDate" placeholder="Promo Date" type="text" class="form-control" value="" />
