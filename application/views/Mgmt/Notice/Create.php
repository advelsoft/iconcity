	...
	<div class="row row-header">
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				echo form_open_multipart("index.php/Common/Notice/Create", $attributes);?>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
								<input id="NoticeDate" name="NoticeDate" placeholder="Notice Date" type="text" class="form-control" value="" />
								<span class="text-danger"><?php echo form_error('NoticeDate'); ?></span>
							</div>
							<label for="DateTo" class="create-label col-md-2">Date To</label>
                            <div class="col-md-4">
								<input id="DateTo" name="DateTo" placeholder="Date To" type="text" class="form-control" value="" />
								<span class="text-danger"><?php echo form_error('DateTo'); ?></span>
							</div>
						</div>
						<div class="form-group">
							<label for="Summary" class="create-label col-md-2">Summary *(Maxlength:300)</label>
							<div class="col-md-10">
