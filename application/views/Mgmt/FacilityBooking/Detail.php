		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-footer">
					<a href="<?php echo base_url()."index.php/Common/FacilityBooking/Update/".$fbRecord['bookingID'].'?Date='.date("Y-m-d", strtotime($fbRecord['dateFrom']));?>">
						<div class="btn btn-sm btn-grey">Edit</div>
					</a>
					<a href="<?php echo base_url()."index.php/Common/FacilityBooking/Delete/".$fbRecord['bookingID'];?>">
						<div class="btn btn-sm btn-grey">Delete</div>
					</a>
				</div>
			</div>
		</div>
