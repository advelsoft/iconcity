	...
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				echo form_open("index.php/Common/FacilityBooking/Update/".$bookingID.'?Date='.date("Y-m-d"), $attributes);?>
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							<label for="Description" class="create-label col-md-2">Facility</label>
							<div class="col-md-10">
								<input id="Description" name="Description" placeholder="Description" type="text" class="form-control" value="<?php echo $fbRecord['description']; ?>" readonly />
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								...
								echo form_dropdown('PropertyNo',$usersPropNo,set_value('PropertyNo', $fbRecord['userid']),$attributes);?>
								<span class="text-danger"><?php echo form_error('PropertyNo'); ?></span>
								<input id="userid" name="userid" type="hidden" value="<?php echo $fbRecord['userid']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="DateFrom" class="create-label col-md-2">Date</label>
							<div class="col-md-10">
								<input id="DateFrom" name="DateFrom" placeholder="DateFrom" type="text" class="form-control" value="<?php echo date("Y-m-d", strtotime($fbRecord['dateFrom'])); ?>" readonly />
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								echo form_dropdown('TimeFrom',$timeFrom,set_value('TimeFrom', $fbRecord['timeFrom']),$attributes);?>
							...
							<div class="col-md-4">
								...
								echo form_dropdown('TimeTo',$timeTo,set_value('TimeTo', $fbRecord['timeTo']),$attributes);?>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								...
								echo form_dropdown('Status',$bookingStatus,set_value('Status', $fbRecord['statusID']),$attributes);?>
				...
				<div class="panel-footer">
					...
					<a href="<?php echo base_url()."index.php/Common/FacilityBooking/Delete/".$fbRecord['bookingID'];?>">
						<div class="btn btn-sm btn-grey" style="float: right;">Delete</div>
					</a>
				</div>
				<?php echo form_close(); ?>
			</div>
