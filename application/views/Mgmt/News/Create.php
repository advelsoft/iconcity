				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control" id="Summary" name="Summary" placeholder="Summary (Maxlength:300)" rows="5" maxlength="300"></textarea>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
								<input id="NewsfeedDate" name="NewsfeedDate" placeholder="Newsfeeds Date" type="text" class="form-control" value="" />
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
								<input id="PublishDateFrom" name="PublishDateFrom" placeholder="Publish Date From" type="text" class="form-control" value="" />
                            ...
                            <div class="col-md-4">
								<input id="PublishDateTo" name="PublishDateTo" placeholder="Publish Date To" type="text" class="form-control" value="" />
						...
						<div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="Publish" name="Publish" type="checkbox" class="form-control" value="1" <?php echo set_checkbox('Publish','1'); ?> />
