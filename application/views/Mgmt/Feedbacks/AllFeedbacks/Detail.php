					...
					<div class="modal fade" id="closed" tabindex="-1" role="dialog" aria-labelledby="taskform" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								echo form_open("index.php/Common/AllFeedbacks/Close/".$UID, $attributes);?>
								<!-- Modal Header -->
								...
								<div class="modal-body">
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input id="CompletedDate" name="CompletedDate" placeholder="Completed Date" type="text" class="form-control" value="" />
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<?php foreach($replyFeedbacks as $item) { ?>
								<?php if ($item['createdBy'] == $_SESSION['userid']): ?>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-5">
												...
												echo form_dropdown('Priority',$priority,set_value('Priority', $allFeedbacks[0]->Priority),$attributes);?>
					...
					<div class="modal fade" id="forward" tabindex="-1" role="dialog" aria-labelledby="taskform" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								echo form_open("index.php/Common/AllFeedbacks/SendMail/".$UID, $attributes);?>
								<!-- Modal Header -->
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								...
								<div class="modal-body">
									<div class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input id="PropertyNo" name="PropertyNo" placeholder="Property No" type="text" class="form-control" value="<?php echo $allFeedbacks[0]->PropertyNo; ?>" readonly />
