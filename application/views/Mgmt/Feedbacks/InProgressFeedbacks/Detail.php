			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<dl class="dl-horizontal">
						<dt>Feedback ID</dt>
						<dd><?php echo $inProgressFeedbacks[0]->FeedbackID; ?></dd>
						
						<dt>Priority</dt>
						<dd><?php echo $inProgressFeedbacks[0]->Priority; ?></dd>
						
						<dt>Owner Name</dt>
						<dd><?php echo $inProgressFeedbacks[0]->OwnerName; ?></dd>
					...
					<div class="modal fade" id="closed" tabindex="-1" role="dialog" aria-labelledby="taskform" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								echo form_open("index.php/Common/InProgressFeedbacks/Close/".$UID, $attributes);?>
								<!-- Modal Header -->
									...
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												...
												<input id="propNo" name="propNo" type="hidden" value="<?php echo $inProgressFeedbacks[0]->PropertyNo; ?>">
											</div>
										</div>
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-5">
												...
												echo form_dropdown('Priority',$priority,set_value('Priority', $inProgressFeedbacks[0]->Priority),$attributes);?>
