								...
								<div class="panel-body">
									<div class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-md-6">
												<input id="ENQUIRYEMAIL" name="ENQUIRYEMAIL" placeholder="Email" type="text" class="form-control" value="<?php if ($setupList[0]->ENQUIRYEMAIL != '') { echo $setupList[0]->ENQUIRYEMAIL; } ?>" />
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input id="ENQUIRYUSERNAME" name="ENQUIRYUSERNAME" placeholder="Username" type="text" class="form-control" value="<?php if ($setupList[0]->ENQUIRYUSERNAME != '') { echo $setupList[0]->ENQUIRYUSERNAME; }  ?>" />
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input id="ENQUIRYPASSWORD" name="ENQUIRYPASSWORD" placeholder="Password" type="password" class="form-control" value="<?php if ($setupList[0]->ENQUIRYPASSWORD != '') { echo $setupList[0]->ENQUIRYPASSWORD; } ?>" />
