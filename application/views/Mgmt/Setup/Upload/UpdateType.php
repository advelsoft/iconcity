							...
							<table class="table table-striped table-hover footable" data-page-size="10">
								...
								<tbody>
									...
									<tr>
										...
										<td><div class="btn btn-sm btn-grey"><a href="#" data-toggle="modal" data-target="#edit<?php echo $uploadTypeList[$i]->UploadTypeId; ?>">Edit</a></div></td>
										<!-- Modal -->
										...
										<td><div class="btn btn-sm btn-grey"><a href="#" data-toggle="modal" data-target="#delete<?php echo $uploadTypeList[$i]->UploadTypeId; ?>">Delete</a></div></td>
										<!-- Modal -->
