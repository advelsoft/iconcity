	...
	<div class="row row-header">
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				echo form_open_multipart("index.php/Common/Upload/Create", $attributes);?>
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							<label for="File" class="create-label col-md-2">File</label>
                            <div class="col-md-10">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-10">
								...
								echo form_dropdown('Type',$uploadType,set_value('Type'),$attributes);?>
