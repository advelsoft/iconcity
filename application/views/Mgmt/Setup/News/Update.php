						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-10">
									...
									echo form_dropdown('NewsType',$newsType,set_value('NewsType', $newsRecord[0]->NewsTypeID),$attributes);?>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea class="form-control" id="Summary" name="Summary" placeholder="Summary (Maxlength:300)" rows="4" maxlength="300"><?php echo $newsRecord[0]->Summary?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea class="form-control" id="Description" name="Description" rows="4"><?php echo $newsRecord[0]->Description?></textarea>
