		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div>
						<a href="<?php echo base_url()."index.php/Common/Categories/Create";?>">
					...
					<div class="table-responsive">
						<table class="table table-striped table-hover table-custom footable">
							<thead>
								<tr>
									<th data-class="expand">Categories</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>   
										<a href="<?php echo base_url()."index.php/Common/Categories/Update/".$item['UID']; ?>" style="text-align:center">
											<div class="btn btn-sm btn-grey" style="text-align:center">Edit</div>
										</a>
										<a href="<?php echo base_url()."index.php/Common/Categories/Delete/".$item['UID']; ?>" style="text-align:center">
