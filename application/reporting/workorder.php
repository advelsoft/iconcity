...
<head>
	...
	<script type="text/javascript">
		...
		report.loadFile("<?php echo base_url()."application/reporting/reports/WorkorderM.mrt";?>");
		report.dictionary.variables.getByName("WOrderID").valueObject = <?php echo $WOrderID; ?>;
